...
function Show-AccessInfo {
    ...
    Write-Host ('  .' + [char]92 + 'docker-start.ps1 stop') -ForegroundColor Gray
    Write-Host "  or"
...
function Start-DCSStatistics {
    ...
    if (-not (Test-Path ('.' + [char]92 + 'dcs-stats' + [char]92 + 'data'))) {
        $needsFix = $true
    }
    ...
    if ($needsFix) {
        ...
        Write-Host ('.' + [char]92 + 'fix-windows-issues.ps1') -ForegroundColor Cyan -NoNewline
    ...
    if (-not (Test-DockerInstalled)) {
        ...
        Write-Host ('.' + [char]92 + 'fix-windows-issues.ps1') -ForegroundColor Cyan
    ...
    try {
        ...
        Write-Host ('.' + [char]92 + 'docker-start.ps1 logs') -ForegroundColor Cyan
