...
- 🎨 Moved Menu Manager admin styling into a versioned `dcs-stats/css/admin/menu-manager.css` asset so updated/demo installs no longer depend on replacing preserved `site-config/css/admin.css`. *(11 July 2026)*
