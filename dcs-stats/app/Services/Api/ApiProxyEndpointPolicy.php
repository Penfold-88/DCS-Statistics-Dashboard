...
final class ApiProxyEndpointPolicy
{
    private array $allowedEndpoints = [
        ...
        '/leaderboard' => ['GET'],
        '/linkme' => ['POST'],
        '/mission/bullseyes' => ['GET'],
        '/mission/drawings' => ['GET'],
