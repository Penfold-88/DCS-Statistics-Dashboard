    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                ...
                <?php require DCS_ROOT_PATH . '/app/Views/Admin/squadron_settings/form.php'; ?>
                <?php require DCS_ROOT_PATH . '/app/Views/Admin/squadron_settings/preview.php'; ?>
                <?php require DCS_ROOT_PATH . '/app/Views/Admin/squadron_settings/ideas.php'; ?>
            </div>
        </main>
    </div>
</body>
